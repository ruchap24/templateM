  ...
  return (
    <div className='mt-5'>
        <p className='mt-5 text-lg text-gray-400'>
            ...
            <Textarea className="w-full h-40 mt-5 p-3 border border-gray-300 rounded-lg" placeholder="Enter your details here..."></Textarea>
        <Button className='mt-5 bg-blue-500 text-white hover:bg-blue-600'>Generate Template</Button>
        {/* <p className='mt-5 text-lg text-gray-400'>
